...
public class RendererTests {
    ...
    public void StringIsConvertedToBuffer() {
        string content = """
            ...
            789
            """;
        Cell[] buffer = Renderer.StringToBuffer(content, 3, 3);
    ...
    [Fact]
    public void StringOverflowsWidthTruncated() {
        string content = """
            abcd
            efgh
            ijkl
        ...
        Assert.Equal('e', buffer[3].Value);
        Assert.Equal('f', buffer[4].Value);
        Assert.Equal('g', buffer[5].Value);
        Assert.Equal('i', buffer[6].Value);
        Assert.Equal('j', buffer[7].Value);
        Assert.Equal('k', buffer[8].Value);
    }
    ...
    public void StringOverflowsHeightTruncated() {
        string content = """
            ...
            ghi
            """;
        Cell[] buffer = Renderer.StringToBuffer(content, 3, 2);
    ...
    [Fact]
    public void StringOverflowsAllDimensionsTruncated() {
        string content = """
            abcd
            efgh
            ijkl
